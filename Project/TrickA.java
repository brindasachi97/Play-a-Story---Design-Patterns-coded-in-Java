...
/* TrickA is one of the strategies implementing mageStrategyIF for Mage's Story */
/* Used to perform a mage's trick */
public class TrickA implements mageStrategyIF {
    public void magic(){
        
        System.out.println("You are performing Trick A");
        System.out.println();
        
        System.out.println("You are still performing the Trick A");
        System.out.println();
